...
* Run Python generators (on Ruby 2.1.5, jruby 9.1.8.0 or later).
* Python 3 (version 2 support has been removed)
...
=== Specific Python Version
  ...
  RubyPython.start(:python_exe => "python3.5") # Can also be a full path
